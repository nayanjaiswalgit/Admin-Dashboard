      ...
      >
        ...
        >
          <div className="flex justify-between items-center">
            <div>
              <p className="font-bold text-grey-400">Earning</p>
              <p className="2xl">₹ 63,448.78</p>
            </div>
          </div>
          <div className="mt-6">
            <Button
      ...
      >
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
          ...
          <div className="mt-10 flex gap-10 flex-wrap justify-center">
            <div className="border-r-1 border-color m-5 pr-10">
              <div >
                <p>
                  <span className="text-3xl font-semibold">₹ 48,448.78</span>
              ...
              <div className="mt-8">
                <p>
                  <span className="text-3xl font-semibold">₹ 63,448.78</span>
                     </p>
                <p>
            ...
            <div className="mt-10 "> <Button color={"white"}
            bgColor="blue"
            text = "Downlord Report"
            borderRadius = "10px "
            /></div>
            </div>
          </div>
