...
const Sidebar = () => {
  ...
  const activeLink = 'flex itmes-center gap-5 pl-4 pt-3 pb-2.5 rounded-lg text-white text-white text-md m-2 ';
    ...
    <div className="ml-3 h-screen md:overflow-hidden overflow-auto md:hover:overflow-auto pb-10">
      ...
      <div className="flex justify-between items-center">
        ...
        className="items-center gap-3 ml-3 mt-4 flex text-xl font-extrabold tracking-tight dark:text-white text-slate-900">
          <SiShopware/> <span>Nayce</span>
        </Link>

        <TooltipComponent content="Menu" position="BottomCenter">
           <button type="button" onClick={()=>setActiveMenu((prevActive)=> !prevActive)} className="text-xl rounded-full p-3 hover:bg-light-gray-mt-4 block md:hidden"><MdOutlineCancel /></button>
        </TooltipComponent>
        </div>  
        {
