    ...
    <div>
      <BrowserRouter>
        <div className="flex relative dark:bg-main-dark-bg">
          <div className="fixed  right-4 bottom-4" style={{zInde
          :'1000'}}>
            <TooltipComponent content  ="Setting" position= "Top">
              <button type="button" className="text-3xl p-3 hover:drop-shadow-xl hover:bg-light-gray text-white"
             style={{backgroud : 'blue', borderRadius: '50%'
            }}>
              <FiSettings/>
              </button>  
            </TooltipComponent>
          ...
          {activeMenu ? (<div className="w-72 fixed sidebar dark:bg-secondary-dark-bg bg-white">
            ...
            <div className={ `dark:bg-main-bg bg-main-bg min-h-screen w-full ${activeMenu ? 'md:ml-72' : 'flex-2'}`}>
              <div className="flxed md:static bg-main-bg dark:bg-main-dark-bg navbar w-full">
                <Navbar/>
                </div>
